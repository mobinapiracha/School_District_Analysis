...
If there is any impact on school size, it will be in the medium size schools as Thomas High School is a medium sized school. However, since the changes are so insignificant after the removal of 9th grade results at Thomas High School, there are no significant changes at one decimal place or integer values. Medium size school scores remain the same. 

### Scores by School Type

#### Scores by School Type
![](Pictures/Module_PyCitySchools/scores_by_type_module.PNG)
...
However, after conducting this school district analysis we found out that due to academic dishonesty we had to set values for 9th grade students reading and math results at Thomas High School to nan, therefore not accounting these results in our analysis. After making these changes we redid the analysis. The changes were minimal. We found that on the district summary, the changes were minimal, average math scores decrease by 0.1 and reading scores remained unchanged. Percentage passing for Mth fell by 0.2% and Percentage Passing for Rading fell by 0.3%. Overall Passing Percentage fell by 0.1%.  In terms of results for Thomas High School We found that the changes were also relatively minimal, all changes not greater than 0.25 points or percentage points. Average Math results decreased by 0.06 Average Reading results increased by 0.05. Percentage Passing for Math fell by 0.09% and Percentage Passing for Reading fell by 0.3% and lastly Overall Percentage Passing fell by 0.23%. Thomas remained at number 2 for the top 5 schools by Overall Passing Percentage. Other than a nan value for 9th grade math and reading scores in the Math and Reading Scores by Grade, there were no changes in results by Grade, there were also no changes by one decimal place or integers for Scores by Spending Ranges, Scores by Size and Scores by Type. Therefore, changes in 9th grade math and reading had an overall very little impact, especially on group based metrics such as spending ranges, school size and school type, while had minimal impact on the district summary and school summary for Thomas. 
